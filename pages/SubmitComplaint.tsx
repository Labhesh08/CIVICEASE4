        ...
        {step === 1 ? (
          ...
          <div className="space-y-16 animate-in fade-in slide-in-from-right-16 duration-700">
            <div className="text-center">
              ...
              <p className="text-slate-500 font-medium text-lg italic">Upload mandatory photographic proof for regional hub verification.</p>
            </div>

            <div 
              className={`relative border-8 border-dashed rounded-[4rem] h-[550px] flex flex-col items-center justify-center transition-all duration-700 group cursor-pointer ${image ? 'border-emerald-500 bg-emerald-50/20' : 'border-slate-50 bg-slate-50/50 hover:border-blue-400 hover:bg-white'}`}
            ...
            >
              ...
              {image ? (
                ...
                <div className="text-center space-y-8">
                  <div className="w-28 h-28 bg-blue-100 rounded-[2.5rem] flex items-center justify-center mx-auto text-blue-600 shadow-2xl shadow-blue-50 group-hover:scale-110 transition-transform duration-500">
                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                  </div>
                  <p className="text-sm font-black text-slate-400 uppercase tracking-[0.4em]">Index Visual Proof</p>
                </div>
              )}
            </div>
            ...
            <div className="flex space-x-8">
              ...
              <button 
                ...
                className="flex-[2] py-7 bg-[#2563EB] text-white rounded-full font-black shadow-2xl shadow-blue-200 hover:bg-blue-700 transition-all active:scale-95 disabled:bg-slate-100 disabled:text-slate-300"
              >
